...
import ICN_1 from "./assets/ICN_1.svg";
...
export default function Template(props: TemplateProps<KcContext, I18n>) {
  ...
  useEffect(() => {
    ...
    console.log(props.kcContext.pageId);
  }, []);
  ...
  return (
    ...
    >
      <div className="right-container">
        <div className="registeration-container normal-font">
          ...
          <span style={{ fontSize: "1rem", fontWeight: 700 }}>
            {kcContext.pageId === "login.ftl"
              ? "Create your account less than a minute"
              : kcContext.pageId === "register.ftl"
          ...
          >
            <img
              src={kcContext.pageId === "login.ftl" ? ICN_1 : ExitIcon}
              alt="Icon"
            />
          </a>
        </div>
          ...
          <div id="kc-header" className={getClassName("kcHeaderClass")}>
            ...
            >
              {kcContext.pageId === "login-reset-password.ftl"
                ...
                ? "Can’t wait to see you! Just one step more..."
                : "Welcome to Flickit"}
              {/* 
