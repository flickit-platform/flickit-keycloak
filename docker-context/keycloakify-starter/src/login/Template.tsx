  ...
  return (
    ...
    >
      <div className="right-column">
        <div>
          <h1>New in Flickit?</h1>
          <span>Create your account less than a minute</span>
          <a tabIndex={6} href="#">
          <img src={ICN_1} alt="Icon" />
          </a>
        </div>
      </div>
      <div className="test">
        <div id="kc-header" className={getClassName("kcHeaderClass")}>
          <div
            ...
            style={{ fontFamily: '"Work Sans"',fontSize:"48px",fontWeight:"bold",textShadow:"0px 1px 2px #0A2342"}}
          >
            {/* 
